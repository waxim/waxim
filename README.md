...
- [Wraith](https://www.npmjs.com/package/wraith-cli): Wraith is an agent harness that allows you to deligate issues to other agents, with prompt enrichment and smart effort.
